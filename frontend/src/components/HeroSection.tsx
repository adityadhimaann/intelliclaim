...
const dashboardImageModules = import.meta.glob<{ default: string }>(
  '../assets/*.{png,jpg,jpeg}',
  {
    eager: true
  }
...
const DASHBOARD_SLIDES = Object.entries(dashboardImageModules).map(([key, module]) => ({
  src: module.default,
  alt: formatAltText(key.split('/').pop() || 'Dashboard')
}));
